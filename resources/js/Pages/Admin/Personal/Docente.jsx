...
import DataTablePersonalDocente from '@/Components/DataTable/Personal/DataTablePersonalDocente';


export default function Docente({tipoDocente,auth}) {
    ...
    const nuevo_tipo = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Inertia.post(route('p.personalDocente.create'),{
                    _method: 'post',
    ...
    return (
        <Navbar auth={auth}>
            ...
            <div className='w-full flex justify-between mt-10 mb-5'>
                ...
                <TitlePages texto={'Docentes del Sistema'} icono={faUserEdit}/>
                <Link
                    onClick={nuevo_tipo}
            ...
            <div className="overflow-x-auto relative shadow-md rounded-lg mt-5 p-4 bg-[#F9FAFB]">
                <DataTablePersonalDocente datos={tipoDocente}/>
            </div>
