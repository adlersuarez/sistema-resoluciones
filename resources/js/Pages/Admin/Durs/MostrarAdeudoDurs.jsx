...
const MostrarAdeudoDurs = ({auth,estado_adeudo}) => {
    ...
    const {data, setData, errors, put, progress} = useForm({
        ...
        estado: estado_adeudo.b_estadoPAI,

    });

    //console.log(data.estado)

    const validar_durs = (e) => {
        Swal.fire({
            title: '¿Está seguro(a)?',
            text: "Usted validará que el estudiante no adeuda en DURS",
            icon: 'warning',
            ...
            confirmButtonText: 'Aceptar'
                ...
                if (result.isConfirmed) {
                    ...
                    Inertia.post(route('d.durs.validarPai',`${estado_adeudo.id_pagoPAI}`),{
                        _method: 'put',
        ...
        Swal.fire({
            ...
            confirmButtonText: 'Aceptar'
                ...
                if (result.isConfirmed) {
                    ...
                    Inertia.post(route('d.durs.notificarPai',`${estado_adeudo.id_pagoPAI}`),{
                        _method: 'put',
                        //comentario: result.value,
                    })
                            ...
                            <div className="flex items-center justify-between">
                                {
                                    ...
                                    <BotonVolver ruta={'d.durs'}/>
                                    :
                                    <BotonVolver ruta={'d.durs.validado'}/>
                                }
...
export default MostrarAdeudoDurs