...
import List_DursValidados from '@/Components/Durs/List_DursValidados';
    ...
    return (
        <Navbar auth={auth}>
            ...
            <div className='flex flex-col mt-10'>
                ...
                <TitlePages texto={'Durs | Validados'} icono={faFileCircleCheck}/>
                    ...
                    <tbody>
                        {   estado_adeudo.data.length != 0  ?
                            ...
                            estado_adeudo.data.map(estado => {
                                return( 
                                    <List_DursValidados estado={estado} key={estado.id_pago}/>
                                )
                            })
                            :
                                <FooterTablaNotFound/>
