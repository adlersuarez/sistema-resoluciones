...
import List_Facultades from '@/Components/Facultades/List_Facultades';
    ...
    return (
        <Navbar auth={auth}>
            ...
            <div className='flex flex-col mt-10'>
                ...
                <TitlePages texto={'Facultades | Pendientes'} icono={faBookBookmark}/>
                    ...
                    <tbody>
                        {   estado_adeudo.data.length != 0  ?
                            ...
                            estado_adeudo.data.map(estado => {
                                return( 
                                    <List_Facultades estado={estado} key={estado.id_pago}/>
                                )
                            })
                            :
                                <FooterTablaNotFound/>
