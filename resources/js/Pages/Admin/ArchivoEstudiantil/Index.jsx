...
import List_ArchivoEstudiantil from '@/Components/ArchivoEstudiantil/List_ArchivoEstudiantil';
    ...
    return (
        <Navbar auth={auth}>
            ...
            <div className='flex flex-col mt-10'>
                ...
                <TitlePages texto={'Archivo Estudiantil | Pendientes'} icono={faArchive}/>
                    ...
                    <tbody>
                        {   estado_adeudo.data.length != 0  ?
                            ...
                            estado_adeudo.data.map(estado => {
                                return( 
                                    <List_ArchivoEstudiantil estado={estado} key={estado.id_pago}/>
                                )
                            })
                            :
                                <FooterTablaNotFound/>
