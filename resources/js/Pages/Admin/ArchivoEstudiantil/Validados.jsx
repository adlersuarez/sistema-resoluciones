...
import List_AEValidados from '@/Components/ArchivoEstudiantil/List_AEValidados';
    ...
    return (
        <Navbar auth={auth}>
            ...
            <div className='flex flex-col mt-10'>
                ...
                <TitlePages texto={'Archivo Estudiantil | Validados'} icono={faFileCircleCheck}/>
                    ...
                    <tbody>
                        {   estado_adeudo.data.length != 0  ?
                            ...
                            estado_adeudo.data.map(estado => {
                                return( 
                                    <List_AEValidados estado={estado} key={estado.id_pago}/>
                                )
                            })
                            :
                                <FooterTablaNotFound/>
