...
const AprobacionExpedienteTecnico = ({ auth }) => {
    ...
    return (
        <Navbar auth={auth}>
            ...
            <div className='w-full flex justify-between mt-10 mb-5'>
                <TitlePages texto={'Registrar Resolución de Aprobación de Expediente Técnico'} icono={faFileWord} />
...
export default AprobacionExpedienteTecnico