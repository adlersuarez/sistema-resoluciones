...
const CronogramaPagos = ({ auth }) => {
    ...
    function agregar_considerando() {
        ...
        listaConsiderando.push({
            descripcion: "El artículo 23°, inc. v) y w) del Estatuto de la Universidad Peruana Los Andes, disponen que el Consejo Universitario tiene atribución para resolver otras que señale el Estatuto, el Reglamento de Organización y Funciones (ROF) y demás reglamentos de la universidad; asimismo, conocer y resolver todos los demás asuntos que no están encomendados a las autoridades;",
            id: "2",
            nombre: "Resolución",
            tipo: "General"
        })
        ...
        listaConsiderando.push({
            descripcion: "El artículo 201°, inc. f) del Estatuto de la Universidad Peruana Los Andes, establece que es deber de los estudiantes, entre otros: Cumplir puntualmente con las obligaciones económicas fijadas por la universidad; concordante con el artículo 78°, inc. f) del Reglamento Académico;",
            id: "2",
            nombre: "Resolución",
            tipo: "General"
        })
        ...
        listaConsiderando.push({
            descripcion: `La Resolución N° XXXX-2022-CU de fecha 07.12.2022 mediante el cual el Consejo Universitario, aprueba el Calendario Académico General correspondiente al semestre académico 2023-0, 2023-I y 2023-II, Modalidad de Educación Presencial de la Universidad Peruana Los Andes de la Sede Central de Huancayo y Filial Chanchamayo;`,
            id: "3",
            nombre: "Miembros",
            tipo: "General"
        })
        ...
        listaConsiderando.push({
            descripcion: `El Oficio Digital Nº XXX-2023-R-UPLA de fecha XX.XX.XX, mediante el cual el Rector remite la propuesta de cronograma de pagos de cuotas de enseñanza para el semestre académico 2023-0, 2023-I y 2023-II, Modalidad de Educación Presencial de la Universidad Peruana Los Andes de la Sede Central de Huancayo y Filial Chanchamayo, al Secretario General, para ser puesto a consideración del Consejo Universitario por contar con opinión favorable del Director General de Administración;`,
        ...
        listaAsuntos.push(
            {
                ...
                'id': 1,
                'nombre': 'APROBAR',
                'descripcion': `el cronograma de pagos de cuotas de enseñanza para el semestre académico 2023-0, 2023-I y 2023-II, Modalidad de Educación Presencial de la Universidad Peruana Los Andes de la Sede Central de Huancayo y Filial Chanchamayo, según se detalla a continuación:`,
            },
            {
                'cod': 2,
                'id': 3,
            ...
            },
            {
                ...
                'id': 3,
                'nombre': 'ENCARGAR',
                'descripcion': `a los decanos de las Facultades, al Director General de Administración, a los jefes de las Oficinas de Economía y Finanzas, Informática y Sistemas, Marketing y Comunicaciones, y demás instancias académicas y administrativas, el cumplimiento de la presente resolución.`,
            },
            {
                'cod': 4,
                'id': 5,
