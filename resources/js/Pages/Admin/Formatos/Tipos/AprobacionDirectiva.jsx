...
const AprobacionDirectiva = ({ auth }) => {
    ...
    function agregar_visto() {
        const visto_datos = `Oficio Digital N° ${numeroResolucion(data.num_ofi_visto)}-UPLA de fecha ${fecha(data.fecha_ofi_visto)}, Oficio Digital N° ${numeroResolucion(data.num_ofi_visto_2)}-R-UPLA de fecha ${fecha(data.fecha_ofi_visto_2)} y acuerdo de Consejo Universitario en sesión extraordinaria de fecha ${fecha(localStorage.getItem('fecha_resolucion'))}, respectivamente; y,`
    ...
    function agregar_considerando() {
        listaConsiderando.push({
            descripcion: "El Artículo 28° del Estatuto de la Universidad Peruana Los Andes señala que son atribuciones del Rector, entre otros: Presentar a la Asamblea Universitaria la Memoria Anual, el informe semestral de gestión del Rector e informe de rendición de cuentas del presupuesto anual ejecutado;",
            id: "1",
            nombre: "Estatuto",
            tipo: "General"
        })
        ...
        listaConsiderando.push({
            descripcion: "La memoria anual (también denominado informe anual) es un informe con las actividades llevadas a cabo por una organización durante un año completo en este caso de la Universidad Peruana Los Andes. Este se usa para dar a conocer la información a los Miembros del Órgano de Gobierno que es el Consejo Universitario para posteriormente elevarlo a la Asamblea Universitaria, esta información debe contener la información financiera principalmente;",
            id: "2",
            nombre: "Resolución",
            tipo: "General"
        })
        ...
        listaConsiderando.push({
            descripcion: `El Rector de la Universidad Peruana Los Andes mediante Oficio Digital N° ${numeroResolucion(localStorage.getItem('num_ofi_visto_2'))}-2023-R-UPLA de fecha ${fecha(localStorage.getItem('fecha_ofi_visto_2'))} remite la Directiva para la Formulación y Presentación de la Memoria Anual 2022 para ser Visto en Consejo Universitario;`,
            id: "3",
            nombre: "Miembros",
            tipo: "General"
        })
        ...
        listaAsuntos.push(
            {
                ...
                'id': 1,
                'nombre': 'APROBAR',
                'descripcion': `la Directiva para la presentación y formulación de la Memoria Anual 2022, formulada por el Jefe de la Oficina de Planificación, mediante Oficio N° ${numeroResolucion(localStorage.getItem('num_ofi_visto'))}-2023-OPLAN-UPLA de fecha ${fecha(localStorage.getItem('fecha_ofi_visto'))}; presentado por el Señor Rector mediante Oficio Digital N° ${numeroResolucion(localStorage.getItem('num_ofi_visto_2'))}-2023-UPLA de fecha ${fecha(localStorage.getItem('fecha_ofi_visto_2'))}, conforme se detalla a continuación:`,
            },
            {
                'cod': 2,
                'id': 3,
                'nombre': 'ENCARGAR',
                'descripcion': `al Jefe de la Oficina de Planificación la difusión e implementación de la Directiva aprobada en el Artículo 1° de la presente resolución.`,
            },
            {
                'cod': 3,
                'id': 3,
                'nombre': 'ENCARGAR',
                'descripcion': `a los Vicerrectores Académico y de Investigación, a los Decanos de las Facultades, al Director de la Escuela de Posgrado, al Director General de Administración, a los Jefes de las Oficinas de Gestión de la Calidad, Asesoría Jurídica, Informática y Sistemas, Marketing y Comunicaciones, Recursos Humanos, Economía y Finanzas, Admisión y demás Instancias Académicas y Administrativas, el cumplimiento de la presente Resolución.`,
            },
            {
                'cod': 4,
                'id': 5,
                                ...
                                <div className=''>
                                    ...
                                    <div className='flex my-2'>
                                        ...
                                        <input
                                            ...
                                            required
                                        />
                                        <div className='my-auto mx-2'>-2023-UPLA de fecha</div>
                                        <input
                                            type="date"
                                            className="text-gray-500 h-8 my-auto w-36"
