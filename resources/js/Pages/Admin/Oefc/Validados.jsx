...
import List_OefcValidados from '@/Components/Oefc/List_OefcValidados';
    ...
    return (
        <Navbar auth={auth}>
            ...
            <div className='flex flex-col mt-10'>
                ...
                <TitlePages texto={'Caja | Validados'} icono={faFileCircleCheck}/>
                    ...
                    <tbody>
                        {   estado_adeudo.data.length != 0  ?
                            ...
                            estado_adeudo.data.map(estado => {
                                return( 
                                    <List_OefcValidados estado={estado} key={estado.id_pago}/>
                                )
                            })
                            :
                                <FooterTablaNotFound/>
