...
const MostrarAdeudoOefc = ({auth,estado_adeudo}) => {
    ...
    const {data, setData, errors, put, progress} = useForm({
        ...
        estado: estado_adeudo.b_estadoOEF,

    });

    const validar_oefc = (e) => {
        Swal.fire({
            title: '¿Está seguro(a)?',
            text: "Usted validará que el estudiante no tiene deudas económicas",
            icon: 'warning',
            ...
            confirmButtonText: 'Aceptar'
                ...
                if (result.isConfirmed) {
                    ...
                    Inertia.post(route('d.oefc.validarOefc',`${estado_adeudo.id_pagoOEF}`),{
                        _method: 'put',
        ...
        Swal.fire({
            ...
            confirmButtonText: 'Aceptar'
                ...
                if (result.isConfirmed) {
                    ...
                    Inertia.post(route('d.oefc.notificarOefc',`${estado_adeudo.id_pagoOEF}`),{
                        _method: 'put',
                        //comentario: result.value,
                    })
                            ...
                            <div className="flex items-center justify-between">
                                {
                                    ...
                                    <BotonVolver ruta={'d.oefc'}/>
                                    :
                                    <BotonVolver ruta={'d.oefc.validado'}/>
                                }
...
export default MostrarAdeudoOefc