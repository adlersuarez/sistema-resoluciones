...
import SpanNotificacionAdeudo from '../Span/SpanNotificacionAdeudo';
import SpanEstadoDeudaTabla from '../Span/SpanEstadoDeudaTabla';

const List_ArchivoEstudiantil = ({estado}) => {
    ...
    return (
        ...
        <tr className="bg-white border-b">
            ...
            <td className="py-4 px-2 md:px-4 text-center">
                <FormatoTiempo
                    fecha={estado.d_fechaSolicitudNA_Ae}
                />
            </td>
            ...
            <td className="py-4 px-2 md:px-4 text-center">
                ...
                <div className='font-medium text-blue-500 pt-2'>
                    <Link
                        ...
                        href={route("d.archivoEstudiantil.mostrar",`${estado.id_pagoAE}`)}>
            ...
            <td className="py-4 px-2 md:px-4 text-center">
                ...
                <div className='font-medium text-green-500 pt-2'>
                    <SpanNotificacionAdeudo 
                        estado={estado.b_estadoNotificacionNA_Ae}
                    />
                </div>   
...
export default List_ArchivoEstudiantil