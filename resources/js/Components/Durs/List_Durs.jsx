    ...
    return (
        ...
        <tr className="bg-white border-b">
            ...
            <td className="py-4 px-2 md:px-4 text-center">
                <FormatoTiempo
                    fecha={estado.d_fechaSolicitudNA_Pai}
                />
            </td>
            ...
            <td className="py-4 px-2 md:px-4 text-center">
                ...
                <div className='font-medium text-blue-500 pt-2'>
                    <Link
                        ...
                        href={route("d.durs.mostrar",`${estado.id_pagoPAI}`)}
                        >
            ...
            <td className="py-4 px-2 md:px-4 text-center">
                ...
                <div className='font-medium text-green-500 pt-2'>
                    <SpanNotificacionAdeudo 
                        estado={estado.b_estadoNotificacionNA_Pai}
                    />
                </div>   
            </td>
            */}
