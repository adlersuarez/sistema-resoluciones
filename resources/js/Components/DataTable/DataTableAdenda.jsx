...
export default function DataTableAdenda({ datos }) {
    ...
    datos.map((elemento) =>
        data.push({
            ...
            adenda: //elemento.nombreResolucion,
            documento: //elemento.asuntoResolucion,
            empresa: //elemento.nombreTipoResolucion,
            telefono: //elemento.nombreSesion,
